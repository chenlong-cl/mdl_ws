...
int main()
    ...
    rfilter[0].can_id = 0x180B18B0;
    rfilter[1].can_id = 0x180B18B1;
	...
	while(1)
    {
        ...
        if(nbytes2 > 0)
        {
            printf("ID=0x%X DLC=%d data[0]=0x%X data[1]=0x%X data[2]=0x%X\n", frame[1].can_id,
                frame[1].can_dlc, frame[1].data[0],frame[1].data[1],frame[1].data[2]);
