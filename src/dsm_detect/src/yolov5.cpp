...
Yolov5::Yolov5(void *YParam)
{
    ...
    YP = *(yoloparam *)YParam;
    std::cerr << "dsm model is loading: " << YP.ENGINE_DIR << std::endl;
    initEngine();
}
