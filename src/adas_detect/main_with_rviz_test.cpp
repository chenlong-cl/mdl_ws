...
public: 
  ...
  //this->declare_parameter<std::string>("date", "2023-02-10");
  //this->declare_parameter<std::string>("time", "09:10:31");
...
//apa_speed
  ...
  //fd1 = open("/dev/ttyCH9344USB6", O_RDWR | O_NOCTTY);
  ...
  publisher_boundingbox = this->create_publisher<visualization_msgs::msg::MarkerArray>("bbox", 700);
...
private:
  ...
  void topic_callback(const sensor_msgs::msg::Image::ConstSharedPtr msg1,const sensor_msgs::msg::PointCloud2::ConstSharedPtr msg2,const custom_interfaces::msg::Stampstring::ConstSharedPtr msg3)
  {
   ...
   //使能开关，控制检测程序是否执行
    ...
    publisher_boundingbox->publish(detections);
  ...
  rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr publisher_boundingbox;
